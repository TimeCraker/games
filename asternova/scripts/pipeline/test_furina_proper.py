...
# Shift slightly to match head top: delta_z = 0.012
...
bpy.context.scene.render.filepath = os.path.join(out_dir, 'test_furina_proper.png')
bpy.ops.render.render(write_still=True)
print("TEST FURINA PROPER RENDERED")

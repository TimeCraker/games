...
export function GameBackButton({
  ...
  const base =
    "group inline-flex min-h-6 items-center gap-1.5 rounded-full border border-glass-border bg-glass-bg px-3.5 py-2.5 text-[13px] font-medium text-white/90 backdrop-blur-glass-md shadow-sm transition-colors duration-fast hover:bg-white/10 hover:text-white active:scale-[0.98] focus:outline-none focus-visible:ring-2 focus-visible:ring-violet-400/60 focus-visible:ring-offset-2 focus-visible:ring-offset-space-black"
  const pos =
    variant === "floating"

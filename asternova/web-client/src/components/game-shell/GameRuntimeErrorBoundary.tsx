  ...
  render() {
    ...
    return (
      <div className="min-h-[100dvh] w-full overflow-auto bg-[#08090f] p-4 text-white">
        <div className="mx-auto max-w-4xl rounded-2xl border border-[#C0503A]/35 bg-black/40 p-4 shadow-[0_20px_60px_rgba(0,0,0,0.55)]">
          <h1 className="text-lg font-semibold text-[#D98A72]">小游戏运行异常</h1>
          ...
          <div className="mt-4 rounded-xl border border-white/12 bg-black/45 p-3">
            ...
            <pre className="mt-2 whitespace-pre-wrap break-words text-sm text-[#D98A72]">{this.state.message}</pre>
          </div>

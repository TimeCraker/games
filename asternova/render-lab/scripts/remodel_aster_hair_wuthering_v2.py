...
out_render = r"c:\Users\TimeCraker\Desktop\my-workspace\games\asternova\art\render_previews\debug_wuthering_v2.png"
...
# Delete old Hina flaring side curls (Islands 5, 7, 8, 10, 11)
...
def add_closed_wuthering_clump(bm, curve_pts, width_profile, u_tile=(0.36, 0.61), v_tile=(0.08, 0.32), mat_idx=0):
    '''Creates a watertight 3-sided prism clump: front-left, front-right, and back face, with root and tip caps.'''
    n_pts = len(curve_pts)
    ...
    for i in range(n_pts):
        ...
        if i == n_pts - 1:
            ...
            # Left vertex, Ridge/Mid vertex, Right vertex
    ...
    # Root cap: triangle [vL0, vM0, vR0]
    vL0, vM0, vR0 = cross_sections[0]
    f_root = bm.faces.new([vL0, vR0, vM0]) # facing upward/inward
...
# 3. Add Aster's Stylized Clumps (Watertight, Smooth, 1-pixel Outline)
...
w_c1 = [0.011, 0.015, 0.014, 0.010, 0.002]
...
w_l1 = [0.013, 0.017, 0.016, 0.011, 0.002]
...
w_l2 = [0.014, 0.019, 0.017, 0.012, 0.002]
...
w_l3 = [0.015, 0.019, 0.019, 0.017, 0.013, 0.002]
...
w_r1 = [0.013, 0.017, 0.016, 0.011, 0.002]
...
w_r2 = [0.014, 0.019, 0.017, 0.012, 0.002]
...
w_r3 = [0.015, 0.019, 0.019, 0.017, 0.013, 0.002]
...
scene = bpy.data.scenes.new('WutheringRenderSceneV2')
...
print("REMODEL WUTHERING V2 COMPLETE!")
